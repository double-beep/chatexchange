...
public final class User {
    ...
    User(long id, String name, int reputation, boolean moderator, boolean roomOwner, Instant lastSeenDate,
         Instant lastMessageDate, boolean currentlyInRoom, String profileLink) {
        this.id = id;
        this.name = name;
