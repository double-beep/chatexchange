...
class HttpClient {
    ...
    public Response postWithFile(String url, Map<String, String> cookies, String fileKey,
                                 String fileName, InputStream inputStream, String... data) throws IOException {
    ...
    private Response execute(Method method, String url, Map<String, String> cookies, boolean ignoreErrors,
                             String fileKey, String fileName, InputStream inputStream, String... data) throws IOException {
        Connection connection = Jsoup.connect(url).timeout(10 * 1000).ignoreContentType(true).ignoreHttpErrors(ignoreErrors)
                                     .method(method).cookies(cookies).userAgent("Mozilla").data(data);
        if (fileKey != null) {
